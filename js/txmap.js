...
$.ajax({
    ...
    data: {
        key: 'HS5BZ-WSVCU-6Y4VG-GTQRO-ISHIZ-3PF6T',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(30, 114, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
    ...
    try {
        ...
        document.getElementById("welcome-info").innerHTML =
            `&emsp;&emsp;${timeChange} <br>欢迎来自 <b><span style="color: var(--icat-ip-color);font-size: var(--icat-gl-size)">${pos}</span></b> 的朋友<br>&emsp;&emsp;您IP地址为：<b><span>${ip}</span></b><br>&emsp;&emsp;${posdesc} <br><br>`;
    } catch (err) {
